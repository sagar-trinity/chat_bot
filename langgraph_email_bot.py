...
llm = AzureChatOpenAI(deployment_name=os.getenv("AZURE_OPENAI_DEPLOYMENT_NAME"), temperature=0, cache=False, openai_api_key=openai.api_key, openai_api_version=openai.api_version)
